...
function Hero() {
  return (
    <div className="flex flex-col items-center justify-center bg-[#EEEEEE] px-4 py-8 md:py-12 lg:py-16"> 
      <div className="top">
        ...
        <div className="flex w-full max-w-[250px] justify-between mx-auto mb-10 md:mb-20 text-black px-4"> 
      ...
      <div className="bottom w-full px-4 max-w-4xl">
        <img src={hero} alt="Hero illustration of mobile app" className="w-full h-auto object-contain" /> 
      </div>
    </div>
  );
}
